...
`memory/` is archived alongside `MEMORY.md` so the frozen System Index still resolves inside the archive. The helper then link-checks the archived `MEMORY.md`:
