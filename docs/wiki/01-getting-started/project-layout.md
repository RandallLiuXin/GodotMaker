...
**`MEMORY.md`** — A log of discoveries, past mistakes, and important decisions that the AI wants to remember across sessions. The main agent updates it from verified outcomes; Workers cannot write it, and their reports do not automatically become memory. Reading it is useful if you want to understand why the AI made a particular choice in an earlier session.
