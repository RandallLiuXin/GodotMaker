...
- **`DESIGN.md`, `ASSETS.md`, and `MEMORY.md` accumulate across tags.** Don't split per tag — append rows / entries; the `Tag` column on each ASSETS row marks the introducing tag.
...
| Project visual contract | `DESIGN.md` |
